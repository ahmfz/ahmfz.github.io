  ...
  return (
    ...
    >
      ...
      <div className="flex md:order-2">
        <DarkThemeToggle />
        <a
  href="https://www.fiverr.com/mrahmedfayyaz"
  target="_blank"
  rel="noopener noreferrer"
  className={`hidden md:flex mx-3 bg-gray-800 hover:bg-gray-900 text-white font-bold py-2 px-4 transition-all duration-300 flex items-center gap-2 ${
